...
orion_space_station_23_0573(string choice) : choice(choice){
}


// 1D dynamically allocation 
string *tools;
string *supplies;
string *artifacts;
string *repair;
...
// constructer to check for start or end game 
...
// static to count lives
int   orion_space_station_23_0573 :: live=0;
